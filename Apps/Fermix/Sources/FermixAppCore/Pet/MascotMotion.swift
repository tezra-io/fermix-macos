...
enum MascotMotion {
    ...
    static func breathAmp(_ mode: VoiceMode) -> Double {
        switch mode {
    ...
    static func breathPeriod(_ mode: VoiceMode) -> Double {
        switch mode {
    ...
    static func bobAmp(_ mode: VoiceMode) -> Double {
        switch mode {
    ...
    static func bobPeriod(_ mode: VoiceMode) -> Double {
        switch mode {
    ...
    static func swayAmp(_ mode: VoiceMode) -> Double {
        switch mode {
